...
#ifndef _TRADING_NEWORDER_CXX_H_
#define _TRADING_NEWORDER_CXX_H_
...
public:
    ...
    NewOrder &orderId(const std::int64_t value) SBE_NOEXCEPT
    {
    ...
    NewOrder &putSymbol(std::span<const char, N> src) SBE_NOEXCEPT
    {
    ...
    #ifdef SBE_USE_SPAN
    template <typename T>
    NewOrder &putSymbol(T&& src)  SBE_NOEXCEPT requires
    ...
    #ifdef SBE_USE_SPAN
    template <std::size_t N>
    NewOrder &putSymbol(const char (&src)[N]) SBE_NOEXCEPT
    {
    ...
    SBE_NODISCARD std::int32_t price() const SBE_NOEXCEPT
    {
        std::int32_t val;
    ...
    NewOrder &price(const std::int32_t value) SBE_NOEXCEPT
    {
    ...
    NewOrder &quantity(const std::int32_t value) SBE_NOEXCEPT
    {
        std::int32_t val = SBE_LITTLE_ENDIAN_ENCODE_32(value);
